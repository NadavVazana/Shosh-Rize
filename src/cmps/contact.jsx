...
export const Contact=({setPhoneModal,isPhoneModal,isMailModal,setMailModal})=>{
    ...
    return(
        <section className="contact">
            ...
            <div  className={isMailModal? 'mail-modal open-mail' : 'mail-modal'}>
                <h1>srize@gmail.com</h1>
                <img onClick={()=>handleCopyClick('srize@gmail.com')} src={require('../assets/imgs/copy-svgrepo-com.svg').default} alt="" />
            </div>
            <div className="ways">
              <a href="https://www.facebook.com/shoshrize" target={'_blank'}>  <img src={require('../assets/imgs/facebook-svgrepo-com (7).svg').default} alt="" /></a>
               <img onClick={()=>setMailModal(true)} src={require('../assets/imgs/gmail-svgrepo-com.svg').default} alt="" />
